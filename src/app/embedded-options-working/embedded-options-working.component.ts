import {AfterViewInit, Component, Host, OnInit, QueryList, ViewChildren} from '@angular/core';
...
@Component({
  ...
  styleUrls: ['./embedded-options-working.component.scss']
})
export class EmbeddedOptionsWorkingComponent implements OnInit, AfterViewInit {
  ...
  protected initOptions(): void {
    ...
    this.options.changes.subscribe(
      options => this.registerSelectOptions(this.select, options),
    );
